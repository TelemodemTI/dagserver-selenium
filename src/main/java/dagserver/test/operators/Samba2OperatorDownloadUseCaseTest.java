...
public class Samba2OperatorDownloadUseCaseTest extends BaseTest {
	
	@Test
    @Parameters({"url","username","pwd","jarname","dagname","group","cronexpr","step1","file","remoteFile"})
	public void createDagDesignWithStepTest(String url,String username,String pwd,String jarname,String dagname,String group,String cronexpr,String step1,String file,String remoteFile,ITestContext context) throws Exception {
		driver.get(url);
    	...
    	if(login.login(username, pwd)) {
    		...
    		params.sendScript("download "+remoteFile+" "+filepath.replaceAll("\\\\", "/"));
    		params.save();
    		jobs.selectDesigndTab();
